...
/**
 * Stream abstraction for GtaCEP pattern detection. A pattern stream is a stream which emits detected
 ...
 */
public class PatternStream<T extends InjectEvent> {
	...
	PatternStream(final DataStream<T> inputStream, final InjectionPatternFunction<T> function) {
