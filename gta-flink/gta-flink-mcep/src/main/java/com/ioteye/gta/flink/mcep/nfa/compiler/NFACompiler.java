...
package com.ioteye.gta.flink.mcep.nfa.compiler;

import com.ioteye.gta.flink.mcep.nfa.NFA;
import com.ioteye.gta.flink.mcep.nfa.State;
import com.ioteye.gta.flink.mcep.nfa.StateTransition;
import com.ioteye.gta.flink.mcep.nfa.StateTransitionAction;
import com.ioteye.gta.flink.mcep.nfa.aftermatch.AfterMatchSkipStrategy;
import com.ioteye.gta.flink.mcep.pattern.GroupPattern;
import com.ioteye.gta.flink.mcep.pattern.MalformedPatternException;
import com.ioteye.gta.flink.mcep.pattern.Pattern;
import com.ioteye.gta.flink.mcep.pattern.Quantifier;
...
import com.ioteye.gta.flink.mcep.pattern.conditions.RichNotCondition;
...
public class NFACompiler {
	...
	static class NFAFactoryCompiler<T> {
		 ...
		 */
		@SuppressWarnings("unchecked")
		private State<T> createTimesState(final State<T> sinkState, final State<T> proceedState, Quantifier.Times times) {
			State<T> lastSink = sinkState;
			setCurrentGroupPatternFirstOfLoop(false);
